...
pubDate: 2025-01-01
tags: announcement, design-systems, css, accessibility, tokens
---
...
_PS: If you're ready to dive in, the [docs](/docs) have everything you need to get started. But honestly? Just grab the CSS file and start playing around. That's the best way to learn._

<Example code={`<p>Hello, world!</p>`} />
<Blockquote
  attr={`mentions <cite title="Source Title">css-docs.md</cite> file`}
>
  This is a custom callout loaded from the `css-docs` file.
</Blockquote>
